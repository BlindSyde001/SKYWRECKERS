...
namespace VolumetricFogAndMist {
    ...
    public class VolumetricFogInspector : Editor {
        ...
        SerializedProperty _fogOfWarEnabled, _fogOfWarTexture, _fogOfWarCenter, _fogOfWarSize, _fogOfWarTextureSize, _fogOfWarRestoreDelay, _fogOfWarRestoreDuration, _fogOfWarSmoothness;
...
#pragma warning restore 0429
            ...
            if (IsFeatureEnabled(VolumetricFog.SKW_FOG_OF_WAR_ON)) {
                ...
                if (expandFogOfWarSection) {
                    ...
                    EditorGUILayout.PropertyField(_fogOfWarSmoothness, new GUIContent("Smoothness", "Border threshold when setting alpha on fog of war positions."));
